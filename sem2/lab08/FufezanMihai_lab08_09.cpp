/*
 * Fufezan Mihai, 2012, lab08, ex 09
 *
 * Consider the PNC management problem from a previous laboratory where you
 * fully validate the PNC (correct day based on the correct month and the
 * correct year, including the leap years) in which you enter more than one data
 * of Person type in a loop with confirmation, showing at the end how many
 * objects have the correct data entered. Use private static attributes as
 * counters.
 */
